...
public class GameMove implements Serializable {
    ...
    public static GameMove startGame() {
        return new GameMove(MoveType.START_GAME, null, 0, '\0', false);
    }

    public static GameMove placeTotem(String nickname, char tileId) {
        return new GameMove(MoveType.PLACE_TOTEM, nickname, 0, tileId, false);
    }

    public static GameMove takeCard(String nickname, int cardIndex, boolean isUpper) {
        return new GameMove(MoveType.TAKE_CARD, nickname, cardIndex, '\0', isUpper);
    }

    public static GameMove skipExtraDraw(String nickname) {
        return new GameMove(MoveType.SKIP_EXTRA_DRAW, nickname, 0, '\0', false);
    }
