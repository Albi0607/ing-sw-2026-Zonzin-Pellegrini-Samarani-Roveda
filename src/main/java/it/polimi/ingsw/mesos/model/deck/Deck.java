...
public class Deck<T extends Card> {
    ...
    /**
     * Draws and removes a single card from the deck.
     *
     * If the deck is empty, the method returns null. Otherwise, it removes the
     * top card from the stack and returns it.
     *
